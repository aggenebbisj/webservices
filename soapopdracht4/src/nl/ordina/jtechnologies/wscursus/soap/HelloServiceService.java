 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://soap.wscursus.jtechnologies.ordina.nl/", wsdlLocation = "http://localhost:8066/soap-opdracht1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://soap.wscursus.jtechnologies.ordina.nl/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8066/soap-opdracht1?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://soap.wscursus.jtechnologies.ordina.nl/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.wscursus.jtechnologies.ordina.nl/", "HelloServicePort"), HelloService.class, features);
    }
